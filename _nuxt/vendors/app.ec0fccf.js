    ...
    [158], {
        ...
        342: function(t, e, r) {
            ...
            var D = {
                ...
                _ = function(t) {
                    ...
                    })), r = e.lastIndexOf("./index.html"), new RegExp(e.slice(1, r), e.slice(r + 1));
                    var e, r
                },
                A = function(t) {
        ...
        352: function(t, e, r) {
            t.exports = function() {
                ...
                function T(base, t) {
                    C[" " + base] || (F.test(base) ? C[" " + base] = base + "./index.html" : C[" " + base] = $(base, "./index.html", !0));
                    var e = -1 === (base = C[" " + base]).indexOf(":");
                    return "//" === t.substring(0, 2) ? e ? t : base.replace(j, "$1") + t : "./index.html" === t.charAt(0) ? e ? t : base.replace(I, "$1") + t : base + t
                }
